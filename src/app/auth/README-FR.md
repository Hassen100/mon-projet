# 🔐 Composant d'Authentification Angular
...
```json
{
  ...
  "@angular/platform-browser/animations": "^17.0.0"
}
```
...
├── auth.component.spec.ts # Tests unitaires
├── index.ts            # Exports
...
- Changement de mode (login/signup)
...
- **Inscription réussie**: Retour au login

## 🔄 Animation

L'animation de transition entre les formulaires utilise :
- **Cubic-bezier** pour un mouvement naturel
- **Slide horizontal** avec effet de glissement
- **Fade in/out** pour une transition fluide
